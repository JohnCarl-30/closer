/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4c9565ed379737fc75f91b14b2291c6b)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 nodejs_compat
interface __BaseEnv_Env {
	Closer: DurableObjectNamespace<import("./src/server").Closer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "Closer";
	}
